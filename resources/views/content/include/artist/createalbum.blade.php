...
<form id="createForm" method="POST" action="{{ route('banner.store') }}" enctype="multipart/form-data">
    @csrf
        ...
        <div class="col-lg-12 mx-auto">
            <div class="row g-3">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="dropzone needsclick dz-clickable" action="/" id="dropzone-album">
                                <div class="dz-message needsclick">
                                    Upload Audio
                                </div>
                            </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        // Dropzone template for banner
        const bannerPreviewTemplate = `<div class="row">
            <div class="col-md-12 d-flex justify-content-center">
                <div class="dz-preview dz-file-preview w-100">
                    <div class="dz-details">
                        <div class="dz-thumbnail" style="width:95%">
        ...
        const dropzoneBanner = new Dropzone('#dropzone-banner', {
            url: '{{ route('file.upload') }}',
            previewTemplate: bannerPreviewTemplate,
